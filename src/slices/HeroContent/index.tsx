...
/**
 * Props for `HeroContent`.
 */
export type HeroContentProps = SliceComponentProps<Content.HeroContentSlice>;

/**
 * Component for "HeroContent" Slices.
 */
// const HeroContent: FC<HeroContentProps> = ({ slice }) => {
//   return (
//     <>
//       <section
...
//         style={{ padding: "2rem 1rem", backgroundColor: "red" }}
//       >
